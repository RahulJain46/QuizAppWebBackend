...
questionsRouter
  ...
  .post(async function(req, res) {
    ...
    console.log('Connected to MongoDB');
      ...
      const kbcusersresponseCollection = client.db('jindarshan').collection("kbcusersresponse");
      const usersresponseCollection = client.db('jindarshan').collection("usersresponse");
      await kbcusersresponseCollection.insertOne(kbcUserResponse)
      const userResponseResult =  await usersresponseCollection.insertOne(userResponse)
